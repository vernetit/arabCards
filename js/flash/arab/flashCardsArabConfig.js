...
*/
	...
	configApp=poner;
	localStorage.setItem("configAppLocalStorageFCA", configApp);
...
configApp=localStorage.getItem("configAppLocalStorageFCA");
...
$(document).keypress(function(event) {
	...
	if (event.charCode==100){
		...
		localStorage.removeItem('configAppLocalStorageFCA');
